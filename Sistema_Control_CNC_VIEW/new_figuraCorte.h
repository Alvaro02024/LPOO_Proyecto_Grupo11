...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &new_figuraCorte::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &new_figuraCorte::label2_Click);
			// 
			// label3
			// 
			...
			this->label3->Click += gcnew System::EventHandler(this, &new_figuraCorte::label3_Click);
			// 
			// label4
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &new_figuraCorte::label4_Click);
			// 
			// label5
			// 
			...
			this->label5->Click += gcnew System::EventHandler(this, &new_figuraCorte::label5_Click);
			// 
			// textBox1
			// 
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &new_figuraCorte::textBox1_TextChanged);
			// 
			// textBox2
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &new_figuraCorte::textBox2_TextChanged);
			// 
			// comboBox1
			// 
			...
			this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &new_figuraCorte::comboBox2_SelectedIndexChanged);
			// 
			// textBox3
			// 
			...
			this->textBox3->TextChanged += gcnew System::EventHandler(this, &new_figuraCorte::textBox3_TextChanged);
			// 
			// button1
			// 
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(239, 317);
			...
			this->ClientSize = System::Drawing::Size(404, 394);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"new_figuraCorte";
			this->Text = L"Nueva Figura de Corte";
